...
code example provided. You are to write the example to a local files named in 
...
any missing dependencies as revealed by the container logs. Then continue to 
build the image and run the container interatively until all depencies are 
resolved, and the code compiles or runs. 
